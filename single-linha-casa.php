<?php get_header(); ?>
    ...
    <?php while ( have_posts() ) : the_post(); ?>
        ...
        <?php 
                $secao_dupla = get_field('secao_dupla'); 
                if(!$secao_dupla['mostrar_secao_resultados']) {
        ?>
        <section>
            <div class="container">
                <div class="row">
                    <div class="col-md-3">
                        <?php $imagem_1 = $secao_dupla['imagem_1']; ?>
                        <img src="<?php echo esc_url($imagem_1['url']); ?>" alt="<?php echo esc_attr($imagem_1['alt']); ?>" class="img-fluid w-100 h-auto"  />
                    </div>
                    <div class="col-md-3">
                        <h2>
                            <?php if($secao_dupla['titulo_1']) echo $secao_dupla['titulo_1']; ?>
                        </h2>
                        <div>
                            <?php if($secao_dupla['paragrafo_1']) echo $secao_dupla['paragrafo_1']; ?>
                        </div>
                    </div>
                    
                    <div class="col-md-3">
                        <?php $imagem_2 = $secao_dupla['imagem_2']; ?>
                        <img src="<?php echo esc_url($imagem_2['url']); ?>" alt="<?php echo esc_attr($imagem_2['alt']); ?>" class="img-fluid w-100 h-auto"  />
                    </div>
                    <div class="col-md-3">
                        <h2>
                            <?php if($secao_dupla['titulo_2']) echo $secao_dupla['titulo_2']; ?>
                        </h2>
                        <div>
                            <?php if($secao_dupla['paragrafo_2']) echo $secao_dupla['paragrafo_2']; ?>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <?php 
                $secao_mokiti = get_field('secao_mokiti'); 
                if(!$secao_mokiti['mostrar_frase_mokiti_okada']) {
        ?>
        <section class="position-relative bg-primary d-flex justify-content-end">
            <img src="<?php echo esc_url( get_template_directory_uri() . '/img/produtos/mokiti-okada.png' ); ?>" >
            <div class="container position-absolute" style="transform: translate(-50%,-50%); left: 50%; top: 50%;">
                <div class="row">
                    <div class="col-md-5">
                        <div class="text-white paragraph-m">
                            <?php if($secao_mokiti['frase_mokiti_okada']) echo $secao_mokiti['frase_mokiti_okada']; ?>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <?php 
                $secao_informativa_2 = get_field('secao_informativa_2'); 
                if(!$secao_informativa_2['mostrar_secao_informativa']) {
        ?>
        <section id="informativo">
            <div class="container">
                <div class="row">
                    <div class="col-md-6 d-flex align-items-center justify-content-center">
                        <h2 class="kt-1 <?php if($cores_da_secao['cor_titulo_base'] ) echo 'text-'.$cores_da_secao['cor_titulo_base'] ?>">
                            <?php if($secao_informativa_2['titulo_informativo']) echo $secao_informativa_2['titulo_informativo']; ?>
                        </h2>
                    </div>
                    <div class="col-md-6 d-flex align-items-center justify-content-center">
                        <div class="paragraph-large <?php if($cores_da_secao['cor_paragrafo_base'] ) echo 'text-'.$cores_da_secao['cor_paragrafo_base'] ?>">
                            <?php if($secao_informativa_2['paragrafo_informativo']) echo $secao_informativa_2['paragrafo_informativo']; ?>  
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section id="contato" class="bg-light section-p-sm">
            <div class="container">
                <h2 class="kt-1 pb-4 text-primary text-center paragraph-l">Solicite um orçamento</h2>
